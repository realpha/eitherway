...
> [Documentation](https://deno.land/x/eitherway).

Before you ask a question, it is best to search for existing
[Issues](https://github.com/realpha/eitherway/issues) that might help you. In
...
- Determine if your bug is really a bug and not an error on your side e.g. using
  ...
  [documentation](https://deno.land/x/eitherway). If you are looking for
  support, you might want to check [this section](#i-have-a-question)).
- To see if other users have experienced (and potentially already solved) the
  same issue you are having, check if there is not already a bug report existing
  for your bug or error in the
  [bug tracker](https://github.com/realpha/eitherwayissues?q=label%3Abug).
...
- Open an [Issue](https://github.com/realpha/eitherway/issues/new). (Since we
...
eitherway, **including completely new features and minor improvements to
...
- Make sure that you are using the latest version.
- Read the [documentation](https://deno.land/x/eitherway) carefully and find out
  if the functionality is already covered, maybe by an individual configuration.
- Perform a [search](https://github.com/realpha/eitherway/issues) to see if the
...
[GitHub issues](https://github.com/realpha/eitherway/issues).
...
- **Explain why this enhancement would be useful** to most eitherway users. You
